              ...
              <div className="space-y-4 pt-4 border-t border-app-border">
                ...
                <div className="px-4">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 p-3 rounded-xl bg-app-bg border border-app-border text-app-muted hover:text-app-text hover:border-app-accent transition-all"
                  >
                    <Upload size={20} />
